...
class OrderItem extends AbstractStruct implements StructInterface
{
    ...
    const NO_DELIVERY_DAY_MONDAY = 'NoDelivery_Monday';
    const NO_DELIVERY_DAY_TUESDAY = 'NoDelivery_Tuesday';
    const NO_DELIVERY_DAY_WEDNESDAY = 'NoDelivery_Wednesday';
    const NO_DELIVERY_DAY_THURSDAY = 'NoDelivery_Thursday';
    const NO_DELIVERY_DAY_FRIDAY = 'NoDelivery_Friday';
    const NO_DELIVERY_DAY_SATURDAY = 'NoDelivery_Saturday';
    const NO_DELIVERY_DAY_SUNDAY = 'NoDelivery_Sunday';
